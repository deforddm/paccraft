...
const js = ['src/world.js', 'src/game.js', 'src/textures.js', 'src/audio.js', 'src/render.js', 'src/builder.js', 'src/pet.js', 'src/cab.js', 'src/games/breaker.js', 'src/games/digger.js', 'src/games/dash.js', 'src/games/invaders.js', 'src/games/crossing.js', 'src/games/snake.js', 'src/games/stack.js', 'src/games/tntmaze.js', 'src/games/cubehop.js', 'src/games/tower.js', 'src/games/caveworm.js', 'src/games/skyguard.js', 'src/games/meteor.js', 'src/games/minecart.js', 'src/games/bonk.js', 'src/app.js'].map(read).join('\n\n');
